...
"[project]/app/api/create-default-users/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST() {
    try {
        ...
        const { error: upsertError } = await supabaseAdmin.from("users").upsert(users, {
            onConflict: "email"
        });
        if (upsertError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd387f0e._.js.map